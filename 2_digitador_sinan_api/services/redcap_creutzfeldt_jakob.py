...
"""
Este módulo é responsável por buscar dados de notificações de Doença de Creutzfeldt-Jakob
...
def map_to_rpa_format(raw_data):
    """
    Mapeia e transforma os dados brutos de uma notificação de Doença de Creutzfeldt-Jakob
    ...
    for k, v in raw_data.items():
        if k in notificacao_fields:
            # TODO: Atualizar campo de sexo com o sufixo real do agravo CREUTZFELDT-JAKOB
    ...
    resultado = {
        "agravo": "DOENCA_CREUTZFELDT_JAKOB",
...
def get_redcap_filas():
    """
    Busca no banco de dados todas as notificações de Doença de Creutzfeldt-Jakob que estão com
