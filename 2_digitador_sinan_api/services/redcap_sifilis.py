...
"""
Este módulo é responsável por buscar dados de notificações de Sífilis não especificada
...
def map_to_rpa_format(raw_data):
    """
    Mapeia e transforma os dados brutos de uma notificação de Sífilis não especificada
    ...
    for k, v in raw_data.items():
        if k in notificacao_fields:
            # TODO: Atualizar campo de sexo com o sufixo real do agravo SIFILIS
    ...
    resultado = {
        "agravo": "SIFILIS_NAO_ESPECIFICADA",
...
def get_redcap_filas():
    """
    Busca no banco de dados todas as notificações de Sífilis não especificada que estão com
