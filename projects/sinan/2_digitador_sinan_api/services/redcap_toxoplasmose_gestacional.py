...
"""
Este módulo é responsável por buscar dados de notificações de Toxoplasmose Gestacional
...
def map_to_rpa_format(raw_data):
    """
    Mapeia e transforma os dados brutos de uma notificação de Toxoplasmose Gestacional
    ...
    for k, v in raw_data.items():
        if k in notificacao_fields:
            # TODO: Atualizar campo de sexo com o sufixo real do agravo TOXOPLASMOSE GESTACIONAL
    ...
    resultado = {
        "agravo": "TOXOPLASMOSE_GESTACIONAL",
...
def get_redcap_filas():
    """
    Busca no banco de dados todas as notificações de Toxoplasmose Gestacional que estão com
